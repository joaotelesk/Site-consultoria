          ...
          <div className="container grid grid-cols-1 lg:grid-cols-5 lg:gap-x-11">
            <div className="py-7 lg:py-16 flex flex-col lg:col-span-3">
              ...
              <p className="mx-auto mt-4 lg:mt-6 text-green-300 text-sm lg:text-xl max-w-md lg:ml-0  lg:leading-6">
                Simplifique sua jornada rumo à cidadania, escolha nossa empresa
                e conquiste sua documentação com tranquilidade.
              </p>
            </div>
            <Image
                    ...
                    <>
                      ...
                      <AccordionPanel pb={4} m={0} p={0}>
                        <p className="text-sm lg:text-base font-normal text-gray-300 mb-3">
                          Não há um prazo exato para os procedimentos, isso
                          varia de acordo com o volume de pedidos solicitados no
                          momento e a quantidade de pessoas contempladas pelo
                          pedido, mas, em média, os pedidos são concluídos em 2
                          anos.
                        </p>
                      </AccordionPanel>
                    </>
